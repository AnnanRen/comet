    ...
    return (
      ...
      >
        <div className="cp-position">
          ...
          <div className="cp-position-copy card">
    ...
    return (
      ...
      >
        <div className="cp-bridge">
          <div className="cp-bridge-card card">
            <span className="label-mono">WHAT</span>
            <strong>OpenSpec</strong>
          </div>
          <div className="cp-bridge-core">
          ...
          <div className="cp-connector-line is-left" />
          <div className="cp-connector-line is-right" />
        </div>
      </SceneShell>
    );
  }
