...
export default function ResumeEntry({ step }: ChapterStepProps) {
  if (step === 0) {
    return (
      <SceneShell
        ...
        title="/comet 不是简单菜单"
      >
        <div className="re-command-layout">
          <div className="re-terminal card">
          ...
          <div className="re-state-card card">
  ...
  if (step === 1) {
    return (
      <SceneShell
        ...
        title="回来之后，直接继续"
      >
        <div className="re-resume">
          <div className="re-window card">
            <span className="label-mono">previous session</span>
            <strong>工具关闭</strong>
            <p>长任务做到一半，上下文中断。</p>
          </div>
          <div className="re-command-chip">/comet 继续</div>
          <div className="re-window card is-current">
  ...
  if (step === 2) {
    return (
      ...
      >
        <div className="re-spec-list card">
          {specs.map((spec, idx) => (
            <div
  ...
  return (
    ...
    >
      ...
      <div className="re-resume-result card">
